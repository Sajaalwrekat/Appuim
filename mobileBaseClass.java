...
public class mobileBaseClass {
    ...
    String courierAppPath ="C:\\Users\\s.alwraikat\\CourierApp\\AppiumLearning\\src\\main\\resources\\CourierappPrePetech.apk";
    @BeforeTest
    public void mobileAppSetup() throws InterruptedException, IOException {
      ...
      //  options.setApp(storeAppPath);
        options.setApp(courierAppPath);
       // options.setUdid(deviceName);
       // options.setCapability("appium:appPackage", "com.google.android.packageinstaller");
       // options.setCapability("appium:appActivity", "couriers.postaplus.com.couriers.ui.login.LoginActivity");
        ...
        try {
            ...
            for (int i = 0; i < 4; i++) {
                driverApp.findElement(AppiumBy.id("com.android.packageinstaller:id/permission_allow_button")).click();
                Thread.sleep(300);
            }
            Thread.sleep(2000);
       ...
       //driverApp2 = new AndroidDriver(new URL("http://127.0.0.1:4723"), options);
        System.out.print("test before courier app opened app");
    }
    ...
    @Test
    public void longPressForElement(WebElement elementForLong) throws InterruptedException {
        ((JavascriptExecutor) driverApp).executeScript("mobile: longClickGesture", ImmutableMap.of(
                "elementId", ((RemoteWebElement) elementForLong).getId(), "duration", 2000));
        Thread.sleep(2000);
